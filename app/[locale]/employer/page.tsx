        ...
        <div className="relative z-[3] w-full max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="flex flex-col items-center text-center gap-8">
            ...
            <div className="flex gap-3 mb-4">
              <Tag>{t("employer.hero.tag1")}</Tag>
              <Tag>{t("employer.hero.tag2")}</Tag>
            </div>
      ...
      <section className="py-32 container mx-auto">
        <div className="container overflow-hidden">
          ...
          <div className="relative mx-auto max-w-5xl">
            <img src="/is-vereni.png" alt="International hiring services" className="aspect-video max-h-[500px] w-full rounded-xl object-cover" />
          ...
          <div className="mx-auto mt-10 flex max-w-5xl flex-col md:flex-row">
            {t.raw("employer.services.items").map((item: any, index: number) => (
              <div key={index} className="flex grow basis-0 flex-col rounded-md bg-background p-4">
                ...
                {index < t.raw("employer.services.items").length - 1 && (
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {t("employer.process.description")}
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {t.raw("employer.process.steps").map((step: any, index: number) => (
              <div key={index} className="text-center relative">
                ...
                {index < t.raw("employer.process.steps").length - 1 && (
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              {t("employer.stats.title")}
            </h2>
            <p className="text-xl opacity-90">
              {t("employer.stats.description")}
            </p>
          </div>
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {t.raw("employer.stats.items").map((stat: any, index: number) => (
              <div key={index}>

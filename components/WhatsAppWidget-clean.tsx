    ...
    <>
      ...
      {!expanded && (
        <div 
          ...
          className="fixed bottom-6 right-6 w-16 h-16 bg-green-500 hover:bg-green-600 rounded-full shadow-2xl cursor-pointer z-50 flex items-center justify-center animate-slideInFromBottom transition-all duration-300 hover:scale-110"
        >
          <svg 
            viewBox="0 0 24 24" 
            width="32" 
